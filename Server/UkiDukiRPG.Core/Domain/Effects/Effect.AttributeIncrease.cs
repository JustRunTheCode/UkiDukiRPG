...
public class AttributeIncreaseEffect(string name, TimeInterval duration, IScheduler scheduler) : BuffEffect(nameof(AttributeIncreaseEffect), duration, scheduler)
{
